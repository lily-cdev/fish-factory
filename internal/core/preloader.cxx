...
void Preload_Assets_L() {
	...
	for (int Counter1 = 0; Counter1 < Metadata_L.Subcategory_Positions.size(); Counter1++) {
		...
		for (int Counter2 = 0; Counter2 < Metadata_L.Subcategory_Positions[Counter1].size(); Counter2++) {
			...
			Textures.Subcategories.Data[Counter1].Data[Counter2] =
				Load_Button(Fonts.Halftext_Font, Metadata.Subcategories[
	...
	for (int Counter1 = 0; Counter1 < Metadata_L.Subcontents.size(); Counter1++) {
		...
		for (int Counter2 = 0; Counter2 < Metadata_L.Subcontents[Counter1].size(); Counter2++) {
			...
			Textures.Subcontents.Data[Counter1].Data[Counter2] =
				Load_Button(Fonts.Halftext_Font, Metadata.Names[Metadata_L.Subcontents[Counter1][Counter2]],
				Rects.Subcontents.Data[Counter1].Data[Counter2], Colors.Abyss_Black, Colors.Cherry_Blossom);
		}
	}
	...
	for (int Counter1 = 0; Counter1 < Metadata_L.Item_Labels.size(); Counter1++) {
		...
		for (int Counter2 = 0; Counter2 < Metadata_L.Item_Labels[Counter1].size(); Counter2++) {
			...
			Textures.Item_Labels.Data[Counter1].Data[Counter2] =
				Load_Button(Fonts.Halftext_Font, Metadata.Names[Metadata_L.Item_Labels[Counter1][Counter2]], Rects
				.Item_Labels.Data[Counter1].Data[Counter2], Colors.Abyss_Black, Colors.Cherry_Blossom);
		}
	}
	...
	Textures.Save_Settings = Load_Button(Fonts.Subtext_Font, Metadata.Buttons[15],
		Rects.Save_Settings, Colors.Abyss_Black, Colors.Cherry_Blossom);
	...
	Textures.Clear_Tutorial = Load_Button(Fonts.Halftext_Font, Metadata.Buttons[11], Rects.Clear_Tutorial,
	...
	for (int Counter = 0; Counter < 3; Counter++) {
		...
		Textures.Tutorials.Data[Counter] = Load_Button(Fonts.Halftext_Font,
			Metadata.Buttons[Counter + 12], Rects.Tutorials.Data[Counter],
			Colors.Abyss_Black, Colors.Cherry_Blossom);
	}
	...
	for (int Counter = 0; Counter < 2; Counter++) {
		...
		Textures.Cheats.Data[Counter] = Load_Button(Fonts.Halftext_Font,
			Metadata.Buttons[Counter + 9], Rects.Cheats.Data[Counter],
			Colors.Abyss_Black, Colors.Cherry_Blossom);
	}
	...
	for (int Counter1 = 0; Counter1 < 2; Counter1++) {
		...
		Textures.Confirmation.Data[Counter1] = Load_Button(Fonts.Halftext_Font,
			Metadata.Buttons[Counter1 + 6], Rects.Confirmation.Data[Counter1],
			Colors.Abyss_Black, Colors.Cherry_Blossom);
