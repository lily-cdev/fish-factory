...
void Gen_Tutorial(Parameter Unused, Parameter Unused2) {
	Tutorial_Step Template[256] = {
		{ T_Key, 4, 0, "", 0, { ktn_null_point }, NULL, "enable the build tool" },
		{ T_Key, 9, 0, "", 0, { ktn_null_point }, NULL, "open the catalog" },
		{ T_Button, 0, 0, "cultivation", 0, { ktn_null_point }, NULL, "open the \"cultivation\" category", "cultivation" },
		{ T_Button, 0, 0, "algae bed", 0, { ktn_null_point }, NULL, "select the \"algae bed\" item", "algae_bed" },
		{ T_Key, 9, 0, "", 0, { ktn_null_point }, NULL, "close the catalog" },
		{ T_Placement, 0, 0, "", 42, { { 5, 3 }, { 3, 3 }, { 7, 3 }, { 9, 3 }, { 11, 3 }, ktn_null_point }, NULL,
			"pump in algae for the filtration plant" },
		{ T_Key, 9, 0, "", 0, { ktn_null_point }, NULL, "open the catalog" },
		{ T_Button, 0, 3, "processing", 0, { ktn_null_point }, NULL, "open the \"processing\" category", "processing" },
		{ T_Button, 0, 0, "filtration plant", 0, { ktn_null_point }, NULL, "select the \"filtration plant\" item", "filtration_plant" },
		{ T_Key, 9, 0, "", 0, { ktn_null_point }, NULL, "close the catalog" },
		...
		{ T_Key, 9, 0, "", 0, { ktn_null_point }, NULL, "open the catalog" },
		{ T_Button, 0, 0, "generation", 0, { ktn_null_point }, NULL, "open the \"generation\" category", "generation" },
		{ T_Button, 0, 0, "furnace", 0, { ktn_null_point }, NULL, "select the \"furnace\" item", "furnace" },
		{ T_Key, 9, 0, "", 0, { ktn_null_point }, NULL, "close the catalog" },
		{ T_Key, 11, 0, "", 0, { ktn_null_point }, NULL, "rotate the machine" },
		{ T_Placement, 0, 0, "", 102, { { 7, 7 }, ktn_null_point }, NULL, "burn fuel for electricity" },
		{ T_Key, 9, 0, "", 0, { ktn_null_point }, NULL, "open the catalog" },
		{ T_Button, 0, 0, "logistics", 0, { ktn_null_point }, NULL, "open the \"logistics\" category", "logistics" },
		{ T_Button, 0, Core.Categories, "reinforced", 0, { ktn_null_point }, NULL, "open the \"reinforced\" subcategory", "heavy" },
		{ T_Button, 0, 0, "reinforced pipe", 0, { ktn_null_point }, NULL, "select the \"reinforced pipe\" item", "heavy_pipe" },
		{ T_Key, 9, 0, "", 0, { ktn_null_point }, NULL, "close the catalog" },
		{ T_Placement, 0, 0, "", 0, { { 3, 6 }, { 3, 7 }, { 3, 8 }, { 4, 6 }, { 5, 6 }, { 6, 6 }, { 7, 6 }, { 8, 6 }, { 9, 6 }, { 10, 6 },
			{ 11, 6 }, { 12, 6 }, { 6, 7 }, ktn_null_point }, Get_Machine("heavy_pipe"), "transport fluids between machines" },
		{ T_Key, 9, 0, "", 0, { ktn_null_point }, NULL, "open the catalog" },
		{ T_Button, 0, 0, "logistics", 0, { ktn_null_point }, NULL, "open the \"logistics\" category", "logistics" },
		{ T_Button, 0, 0, "cable node", 0, { ktn_null_point }, NULL, "select the \"cable node\" item", "cable_node" },
		{ T_Key, 9, 0, "", 0, { ktn_null_point }, NULL, "close the catalog" },
		...
		{ T_Key, 9, 0, "", 0, { ktn_null_point }, NULL, "open the catalog" },
		{ T_Button, 0, 0, "generation", 0, { ktn_null_point }, NULL, "open the \"generation\" category", "generation" },
		{ T_Button, 0, 0, "radioisotopic generator", 0, { ktn_null_point }, NULL, "select the \"radioisotopic generator\" item", "rtg" },
