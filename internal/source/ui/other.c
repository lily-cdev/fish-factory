...
void Render_Main() {
	...
	Render_Button(&Textures.Settings, &Rects.Settings, (UI_Link){ Switch_Tab, .Param.Integer = 3 }, Colors.Cherry_Blossom);
	Render_Button(&Textures.Update_Logs, &Rects.Update_Logs, (UI_Link){ Switch_Tab, .Param.Integer = 4 }, Colors.Cherry_Blossom);
